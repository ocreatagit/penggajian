...
--
-- Host: 127.0.0.1
-- Generation Time: 27 Nov 2015 pada 12.02
...
(10, 15, 16, 'Jawa-Timur', 'surabaya', 60000, NULL);
...
INSERT INTO `setoran_bank` (`IDSetoran`, `jumlah`, `keterangan`, `IDCabang`) VALUES
(1, 6500, 'adsasd', 10),
(2, 6500, 'adsasd', 10),
(3, 6500, 'adsasd', 10),
(4, 6500, 'adsasd', 10),
...
--
ALTER TABLE `jurnal`
  MODIFY `IDJurnal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
