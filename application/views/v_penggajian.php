<div class="container" style="margin-top: 80px; height: 100%; padding: 0px; margin-bottom: 50px;">    
    <div class="row" style="">
        <div class="col-lg-12">
            <h1 class="page-header" style="margin-top: 0px;">Input Penggajian</h1>
        ...
        <div class="col-lg-6">
            <div class="panel panel-success siku">
                <div class="panel-heading siku">
                    <h3 class="panel-title">Tambah Data Penggajian</h3>
                </div>
                <div class="panel-body siku">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form method="post" action="<?php echo current_url(); ?>" accept-charset="utf-8" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="sales" id="sales" class="form-control" onchange="get_gaji_sales()">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-3">Gaji : </label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" disabled="" value="---" id="gaji" />
                                        <input type="hidden" value="" name="gaji_hidden" id="gaji_hidden" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control" type="number" min="0" name="bayar" value="" id="bayar"/>
            ...
            <div class="panel panel-info siku">
                ...
                <div class="panel-body siku">
                            ...
                            foreach ($this->cart->contents() as $items):
                                if (strpos($items["id"], "gaji") !== FALSE):
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><a href="<?php echo base_url() ?>index.php/laporan/delete_cart_bayar_gaji/<?php echo $items["id"] ?>"><i class="fa fa-times"></i></a></td>
                                    </tr>
                                    <?php
                                endif;
                            endforeach;
                    ...
                    <div class="text-right">
                        <a id="inputCheck" href="<?php echo base_url() ?>index.php/laporan/simpan_bayar_gaji" class="btn btn-primary siku"><i class="fa fa-forward"></i> Lanjutkan</a>
                    </div>
                </div>
            </div>
        </div>
