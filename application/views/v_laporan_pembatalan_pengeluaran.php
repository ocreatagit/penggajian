<div class="container" style="margin-top: 80px; height: 100%; padding: 0px; margin-bottom: 50px;">    
    <div class="row" style="">
        <div class="col-lg-6">
            <h1 class="page-header" style="margin-top: 0px;">Daftar Pembatalan Pengeluaran</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb" style="background-color: white; margin-top: 00px;">
                <li><a href="<?php echo base_url(); ?>index.php/Laporan/laporan_pengeluaran"><i class="fa fa-home"></i> Daftar Pembatalan Pengeluaran</a></li>
            </ol>
        </div>
    </div>
    ...
    <?php if ($this->session->userdata("Level") != 0) { ?>
        <div style="background-color: white; height: 70px;">
            <div class="col-md-12">
                <a href="<?php echo base_url(); ?>index.php/laporan/pembatalan_pengeluaran" class="btn btn-primary" style="border-radius: 0px; margin-top: 10px;" style="border-radius: 0px;"><i class="fa fa-plus">&nbsp</i> Buat Pembatalan Pengeluaran</a>
            </div>
        </div>
        <?php
    } else {
