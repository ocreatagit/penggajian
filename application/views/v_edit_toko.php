                        ...
                        <div class="col-lg-12">
                            ...
                            <form id="form_s" class="form-horizontal" method="POST" action="<?php echo current_url() ?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="nama_toko" class="form-control siku"placeholder="Masukkan Nama Toko" required="" title="Nama Toko Harus Diisi!" value="<?php echo set_value('nama_toko', $toko->nama) ?>">
                                        <input type="hidden" name="hid" value="7482hdyueldplf"/>
                                        <input type="hidden" name="IDToko" value="<?php echo $toko->IDToko ?>"/>
                                        <?php if (form_error("nama_toko") != "") {
                                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">                                        
                                        <input type="text" name="alamat" class="form-control siku"placeholder="Masukkan Alamat Toko" required="" title="Alamat Harus Diisi!" value="<?php echo set_value('alamat', $toko->alamat) ?>">                                        
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <a href="<?php echo base_url() ?>index.php/toko/toko" class="btn btn-default siku"><i class="fa fa-backward"></i> Kembali</a>
                                        <button id="btn_submit" type="submit" value="tambah_toko" name="btn_submit" class="btn btn-primary siku" id="inputCheck" <?php if ($status_barang == 1) {
                                            echo "disabled";
                                        } ?>>Edit Barang</button>
                                    </div>
                                </div>
